// <copyright file="ITargetResolverBuilder.cs" company="SPS">
...
/// <summary>
/// Interface for choice target resolver building used when more choices are expected after this one.
/// </summary>
...
/// </typeparam>
public interface ITargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent>
    ...
    where TUserId : notnull
{
    ...
    /// </returns>
    public ITargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent> AddTarget(
    ...
    /// The instance of this builder.
    /// </returns>
    public ITargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent> AddTerminal(
        ICondition condition);
    ...
    /// The instance of this builder.
    /// </returns>
    public ITargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent> AddFallback(
        TUserId targetUserId);
    ...
    /// The instance of this builder.
    /// </returns>
    public ITargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent> AddTerminalFallback();

    /// <summary>
    /// Ends the creation of the target resolver.
    /// </summary>
    /// <returns>
    /// The choice builder used to create more choices.
    /// </returns>
