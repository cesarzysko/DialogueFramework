// <copyright file="TargetResolverBuilder.cs" company="SPS">
...
/// <summary>
/// Target Resolver Builder used when more choices are expected after this one.
/// </summary>
...
/// </typeparam>
public sealed class TargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent>
    : TargetResolverBuilderBase<TUserId>,
      ITargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent>
    ...
    where TUserId : notnull
{
    ...
    /// <see cref="TargetResolverBuilder{TRegistryKey, TUserId, TDialogueContent, TChoiceContent}"/> class.
    /// </summary>
    /// <param name="parent">
    ...
    /// </param>
    internal TargetResolverBuilder(
    ...
    /// <inheritdoc/>
    public new ITargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent> AddTarget(
    ...
    /// <inheritdoc/>
    public new ITargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent> AddTerminal(
        ICondition condition)
    {
    ...
    /// <inheritdoc/>
    public new ITargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent> AddFallback(
        TUserId targetUserId)
    {
    ...
    /// <inheritdoc/>
    public new ITargetResolverBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent> AddTerminalFallback()
    {
    ...
    /// <inheritdoc/>
    public IChoiceBuilder<TRegistryKey, TUserId, TDialogueContent, TChoiceContent> End()
    {
